<%@ Page Title="" Language="C#" MasterPageFile="~/Cafe.Master" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="Cafe.Contact" %>
                                    ...
                                    <div class="contactform-wrap">
                                        ...
                                        <form runat="server" class="custom-form" >
                                            ...
                                            <div id="message2"></div>
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <input runat="server" type="text"  name="name" id="name2" placeholder="Your Name *" value=""/>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <input runat="server"  type="text"  name="email" id="email2" placeholder="Email Address *" value=""/>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <input runat="server"  type="text"  name="phone" id="phone2" placeholder="Phone *" value=""/>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class=" fl-wrap">
                                                ...
                                                <textarea runat="server"  name="comments"  id="comments2" cols="40" rows="3" placeholde="Youhr Message:"></textarea>
                                                <div class="clearfix"></div>
                                              
                            <asp:Button ID="SendContact" runat="server" Text="Send Message..." Class="btn float-btn flat-bt colhor-bg" OnClick="SendContact_Click"/>
                                            </fieldset>
                                        </form>
                                    </div>
